GetRptPlotTransferAdmin()




function GetRptPlotTransferAdmin() {
    ProgressBarShow();
    var request = $.ajax({
        method: "POST",
        url: "/PlotTransferAdmin/GetRptPlotTransferAdmin",
    });
    request.done(function (data) {

        onGetRptPlotTransferAdmin(data);
    });
...
function onGetRptPlotTransferAdmin(data) {
...
function getNewFileName() {
    return "RPT_PlotTransferAdmin_" + GetCurrentDate();
}