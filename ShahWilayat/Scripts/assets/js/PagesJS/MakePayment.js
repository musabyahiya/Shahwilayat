...
function AllChangeFunction() {
    ...
    $('.txtPaymentDate').datepicker().on('changeDate', function (ev) {
        ...
        var obj = ChargesList.filter(x=> Year >= x.StartYear && Year <= x.EndYear && x.PlotId == PlotId);
        onGetAllCharges(obj);
    });
...
function AllClickFunction() {
    ...
    $('.btnMakePayment').click(function () {
        ...
        CreateNewPayment(ChargeId, PaymentMethodId, PaymentDate, MemberId, PlotId, Size, PaymentAmount, RemainingBalance, PaidPercentBefore,
            TotalAmount, DueDate, PaymentCategoryId, PaymentSubCategoryId, CategoryPercent, TenureId, Rate);
...
function GetPaymentAmount(ChargeId, MemberId, PlotId) {
    var request = $.ajax({
        method: "POST",
        url: "/MakePayment/GetPaymentAmount",
...
function GetAllPlotType() {
    ...
    var request = $.ajax({
        method: "POST",
        url: "/MakePayment/GetAllPlotType",
        data: {}
    });
    request.done(function (data) {
...
function GetAllPaymentMethod() {
    ...
    var request = $.ajax({
        method: "POST",
        url: "/MakePayment/GetAllPaymentMethod",
        data: {}
    });
    request.done(function (data) {
...
function CreateNewPayment(ChargeId, PaymentMethodId, PaymentDate, MemberId, PlotId, Size, PaymentAmount, RemainingBalance, PaidPercentBefore, TotalAmount, DueDate, PaymentCategoryId, PaymentSubCategoryId, CategoryPercent, TenureId, Rate) {
    ProgressBarShow();

    var request = $.ajax({
        method: "POST",
        url: "/MakePayment/CreateNewPayment",
        data: {
            ...
            DueDate: DueDate, PaymentCategoryId: PaymentCategoryId, PaymentSubCategoryId: PaymentSubCategoryId, CategoryPercent: CategoryPercent, TenureId: TenureId, Rate: Rate
        }
    });
    request.done(function (data) {
...
function SendInvoiceEmail(Html, Email, Subject) {
    ...
    var request = $.ajax({
        method: "POST",
        url: "/MakePayment/SendInvoiceEmail",
