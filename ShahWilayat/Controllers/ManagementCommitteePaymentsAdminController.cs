...
{
    [SessionCheck]
    public class ManagementCommitteePaymentsAdminController : Controller
    {
        ShahWilayatEntities context = new ShahWilayatEntities();
        // GET: ManagementCommitteePaymentsAdmin
        ...
        public string GetRptGetPaymentAmountGeneral()
        {
            try
            {
                ...
                SqlDataAdapter da = new SqlDataAdapter("RptGetPaymentManagementCommitteeWiseAdmin", con);
